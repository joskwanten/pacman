function ghostRenderer(context, tileSize) {
	...
	this.render = function(ghost) {
		...
		ctx.beginPath();
		ctx.arc(this.x + offsetx + (18 / 64) * ghostSize, this.y + offsety + (28 / 64) * ghostSize, 3, 0, 2 * Math.PI, false);
		ctx.fillStyle = 'black';
		ctx.fill();
		ctx.lineWidth = 1;
		ctx.strokeStyle = '#003300';
		...
		ctx.beginPath();
		ctx.arc(this.x + offsetx + (42 / 64) * ghostSize, this.y + offsety + (28 / 64) * ghostSize, 3, 0, 2 * Math.PI, false);
		ctx.fillStyle = 'black';
		ctx.fill();
		ctx.lineWidth = 1;
		ctx.strokeStyle = '#003300';
